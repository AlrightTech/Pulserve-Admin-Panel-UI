    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <span
            className={`mt-2 inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold ${
              user.status === "Active"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
          <h3 className="text-lg font-bold text-custom-charcoal">
          ...
          <div className="pt-6 border-t border-gray-50">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between text-custom-dim-gray">
                <span>Storage</span>
                <span className="font-semibold text-custom-charcoal">
                  500 GB
                </span>
              </div>
              <div className="flex justify-between text-custom-dim-gray">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-8">
          <div>
            <p className="text-sm font-bold text-custom-charcoal mb-4">
              User Growth
            </p>
      ...
      <div className="bg-custom-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="w-full overflow-x-auto">
          <table className="w-full text-left min-w-[600px]">
            {/* min-w-[600px] isliye add kiya taake mobile par columns ek dusre ke upar na charhein */}
            ...
            <tbody className="divide-y divide-gray-50">
              {history.map((item, i) => (
                <tr key={i} className="text-sm text-custom-charcoal">
                  ...
                  <td className="px-6 py-4 text-right text-custom-dim-gray">
                    {item.method}
                  </td>
                </tr>
              ))}
